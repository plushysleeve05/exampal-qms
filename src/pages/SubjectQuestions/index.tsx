...
export default function SubjectQuestions() {
    ...
    }, [examType, currentSubject, selectedYears, selectedSections, selectedTopics, selectedDifficulties, itemsPerPage, fetchQuestions]);
    ...
    const handleSubjectChange = async (newSubject: string) => {
      ...
      // Clear current questions while "loading"
      setAllQuestions([]);
      ...
      try {
        ...
        window.history.pushState(
          ...
          `/exams/${examType}/${formattedForUrl}`
        );
      } catch (error) {
